      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center">
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full glass px-3.5 py-1.5 text-xs text-primary">
            <span className="h-1.5 w-1.5 rounded-full bg-primary animate-pulse" /> {t("ctaKicker")}
          </span>
          <h2 className="mt-6 font-display text-[clamp(3rem,7vw,6rem)] leading-[0.95] tracking-[-0.04em]">
            {t("ctaTitle1")} <span className="italic text-gradient-primary">{t("ctaTitle2")}</span> {t("ctaTitle3")}
          </h2>
          ...
          <div className="mt-6 text-xs text-muted-foreground">{t("ctaFine")}</div>
        </motion.div>
      </div>
    </section>
  );
